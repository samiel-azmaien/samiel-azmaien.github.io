...
The project viewer uses short, muted stock clips as atmospheric backgrounds. They are edited by the site through cropping, color treatment, overlays, and interface graphics.

## Mixkit Stock Video Free License

- Totem: [Subway network in Tokyo](https://mixkit.co/free-stock-video/subway-network-in-tokyo-4453/)
- GPU Architecture: [Microchip technology close up](https://mixkit.co/free-stock-video/microchip-technology-close-up-1140/)
- FND Analysis: [Doctor wearing mask and gloves for protection](https://mixkit.co/free-stock-video/doctor-wearing-mask-and-gloves-for-protection-4745/)
- Swing State Probabilities: [Programmer working with codes on a computer](https://mixkit.co/free-stock-video/programmer-working-with-codes-on-a-computer-41637/)
